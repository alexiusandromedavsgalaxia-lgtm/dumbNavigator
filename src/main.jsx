...
const internalLabel=url=>{const d=domain(url);return ({home:'dumbNavigator · inicio',projects:'dumbNavigator · proyectos',bookmarks:'dumbNavigator · marcadores',settings:'dumbNavigator · ajustes','develope.it':'develope.it · studio'})[d]||visible(url)}
...
function Browser({url,projects,navigate}){
 ...
 if(!p&&publicState==='published')return <iframe title={visible(url)} src={src} className="siteFrame" sandbox="allow-scripts allow-forms allow-same-origin allow-modals"/>
