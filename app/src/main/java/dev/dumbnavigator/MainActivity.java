...
public class MainActivity extends Activity implements ChromiumEngine.Host {
    ...
    @Override public void onPublish(String raw,String html,boolean wildcard){runOnUiThread(()->{
        String h=DumbDomains.publicInternalHost(raw);
        ...
        try{DumbEngine.Loader.save(getApplicationContext(),h,html,wildcard);Toast.makeText(this,"web publicada: dumb://"+h+"/",Toast.LENGTH_LONG).show();engine.go("dumb://"+h+"/");}
